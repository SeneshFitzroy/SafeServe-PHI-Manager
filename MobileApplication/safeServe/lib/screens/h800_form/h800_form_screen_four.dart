                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      RadioButtonField(
                        label: '7.1 Lids of bins closed (1 mark)',
                      ...
                      GenericDropdown(
                        label: '7.2 Cleanliness of waste bins (1 mark)',
                      ...
                      GenericDropdown(
                        label: '7.3 Disposal of waste (1 mark)',
                      ...
                      GenericDropdown(
                        label: '7.4 Adequate number of toilets (1 mark)',
                        initialValue: _adequateNumberOfToilets,
                      ...
                      GenericDropdown(
                        label: '7.5 Location of toilets (1 mark)',
                      ...
                      GenericDropdown(
                        label: '7.6 Cleanliness of toilets (1 mark)',
                      ...
                      GenericDropdown(
                        label: '7.7 Septic tank condition (1 mark)',
                      ...
                      const SizedBox(height: 20),
                      GenericDropdown(
                        label: '8.1 Condition of food (1 mark)',
                      ...
                      GenericDropdown(
                        label: '8.2 Display/packaging (1 mark)',
                      ...
                      RadioButtonField(
                        label: '8.3 Insect infested (1 mark)',
                      ...
                      RadioButtonField(
                        label: '8.4 Violation of labeling (1 mark)',
                      ...
                      RadioButtonField(
                        label: '8.5 Separation of unwholesome food (1 mark)',
                      ...
                      const SizedBox(height: 20),
                      GenericDropdown(
                        label: '9.1 Wearing protective clothing (2 marks)',
                      ...
                      RadioButtonField(
                        label: '9.2 Communicable diseases (1 mark)',
                      ...
                      GenericDropdown(
                        label: '9.3 Good health habits (1 mark)',
                      ...
                      GenericDropdown(
                        label: '9.4 Health records (2 marks)',
                      ...
                      GenericDropdown(
                        label: '9.5 Training records (2 marks)',
                      ...
                      const SizedBox(height: 20),
                      RadioButtonField(
                        label: '10.1 Display health instructions (1 mark)',
                      ...
                      RadioButtonField(
                        label: '10.2 Entertains complaints (1 mark)',
                      ...
                      RadioButtonField(
                        label: '10.3 Prevent smoking (1 mark)',
                      ...
                      RadioButtonField(
                        label: '10.4 Issuing bills (1 mark)',
                        value: _issuingBills,
                      ...
                      RadioButtonField(
                        label: '10.5 Food safety certification (1 mark)',
                        ...
                        children: [
                          ...
                          H800FormButton(
                            ...
                            onPressed: () {
                              if (_validateForm()) {
                                _updateFormData();
                                // Navigate to a summary screen or handle submission
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Form submitted! Total Score: ${widget.formData.calculateTotalScore()} (${widget.formData.calculatePercentage().toStringAsFixed(2)}%)',
                                    ),
                                  ),
                                );
                              }
